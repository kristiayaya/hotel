            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
              <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <li class="nav-item text-white">
                  <a class="nav-link active text-white" aria-current="page" href="/Beranda">Home</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active text-white" href="{{ route('tamu.kamar') }}">Kamar</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active text-white" href="{{ route('FasilitasHotel')}} ">Fasilitas Hotel</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link active text-white" href="">Pemesanan</a>
                </li>
              ...
              @if (Route::has('login'))
                          ...
                          @auth
                            ...
                            <li class="nav-item">
                            <a style="margin-left: 1242px;"class="nav-link active text-white" href="{{ route('logout') }}" onclick="event.preventDefault();
